...
//        env.setStateBackend(new FsStateBackend(""));
    ...
    DataStreamSource<String> pageViewDS = env.addSource(MyKafkaUtil.getFlinkKafkaCounsumer(pageViewSourceTopic, groupId));
    DataStreamSource<String> uvDS = env.addSource(MyKafkaUtil.getFlinkKafkaCounsumer(uniqueVisitSourceTopic, groupId));
    DataStreamSource<String> ujDS = env.addSource(MyKafkaUtil.getFlinkKafkaCounsumer(userJumpDetailSourceTopic, groupId));
