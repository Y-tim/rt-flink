...
//        env.setStateBackend(new FsStateBackend(""));
        ...
        DataStreamSource<String> orderWideStrDS = env.addSource(MyKafkaUtil.getFlinkKafkaCounsumer(orderWideSourceTopic, groupId));
        DataStreamSource<String> paymentStrDS = env.addSource(MyKafkaUtil.getFlinkKafkaCounsumer(paymentInfoSourceTopic, groupId));
        ...
        paymentWideDS.map(JSONObject::toJSONString)
                .addSink(MyKafkaUtil.getFlinkafkaProducer(paymentWideSinkTopic));
